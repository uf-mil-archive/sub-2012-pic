////////////////////////////////////////////////////////////////////////////////
// I2C Actuator Board (header)                       Authored by:   Paul Launier
////////////////////////////////////////////////////////////////////////////////
...
typedef struct { 
	...
	I2C_DATA *oData;        // i2c data object
...
extern I2C_DRV i2cDriver;
extern I2C_DRV i2cActuator;
extern I2C_DATA fanData;
extern I2C_DATA actuatorData;
extern unsigned int jDone;
extern UINT8 actuators;
extern UINT8 limitSwitch;


void __attribute__((interrupt, no_auto_psv)) _MI2C1Interrupt(void);
void __attribute__((interrupt, no_auto_psv)) _SI2C1Interrupt(void);

void updateActuatorStates(I2C_DRV *i2cDRV);
unsigned int getLimitSwitchState(I2C_DRV *i2cDRV);
