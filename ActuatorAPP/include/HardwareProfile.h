...
//****************************** Actuators ******************************/
#define CTRL1_TRIS  TRISAbits.TRISA1
#define CTRL1       LATAbits.LATA1
#define CTRL2_TRIS  TRISBbits.TRISB0
#define CTRL2       LATBbits.LATB0
#define CTRL3_TRIS  TRISBbits.TRISB1
#define CTRL3       LATBbits.LATB1
#define CTRL4_TRIS  TRISAbits.TRISA4
#define CTRL4       LATAbits.LATA4
#define CTRL5_TRIS  TRISBbits.TRISB4
#define CTRL5       LATBbits.LATB4

#define TURN_ON      1                   // The LED is configured
#define TURN_OFF     0                   // to turn on with a high output
//******************************************************************/

//***********************Limit Switch ******************************/
#define LIMITSW_TRIS  TRISAbits.TRISA3
#define LIMITSW       PORTAbits.RA3
