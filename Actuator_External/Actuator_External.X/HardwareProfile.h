////////////////////////////////////////////////////////////////////////////////
// External Actuator Hardware Profile                                 PJL - 2012
////////////////////////////////////////////////////////////////////////////////
...
#define CTRL5       LATAbits.LATA3
#define CTRL6_TRIS  TRISBbits.TRISB4
#define CTRL6       LATBbits.LATB4

#define CTRL1_MASK (1<<0)
#define CTRL2_MASK (1<<1)
#define CTRL3_MASK (1<<2)
#define CTRL4_MASK (1<<3)
#define CTRL5_MASK (1<<4)
#define CTRL6_MASK (1<<5)
...
//***********************Limit Switches*****************************/
#define SW1_TRIS  TRISBbits.TRISB10
#define SW1       PORTBbits.RB10
#define SW2_TRIS  TRISBbits.TRISB11
...
// data sheet. There is no error % checking because we only calculate
