...
//////////////////////////////////////////////////////////////////////////
	...
	// ENC28J60C RAM definitions
#define MAC_TX_BUFFER_SIZE 	1024
#define	MAC_TX_BUFFER_COUNT 1
#define RAMSIZE				8192		

// **** code modified to support ENC28J60 Rev B1 Errata
//#define TXSTART	0x0000u
//#define TXEND	(MAC_TX_BUFFER_COUNT * (MAC_TX_BUFFER_SIZE + 8u))
//#define RXSTART	(TXEND+2u-(TXEND & 0x0001))	// Should be an even memory address
//#define	RXSTOP	(RAMSIZE-1u)
//#define RXSIZE	(RXSTOP-RXSTART+1u)

#define RXSTART		(0x0000)
#define RXSTOP		(0x17ff)
#define RXSIZE		(RXSTOP-RXSTART+1)
#define TXSTART		(RXSTOP+1)	// Should be an even memory address
#define TXEND		(RAMSIZE-1)
// **** end of code modified to support ENC28J60 Rev B1 Errata


#define MAXFRAMEC	(1500u+sizeof(ETHER_HEADER)+4u)

	// ENC28J60 Commands to be ORed with target address
#define	WCR (0b01000000)	// Write Control Register
#define BFS (0b10000000)	// Bit Field Set
#define	BFC (0b10100000)	// Bit Field Clear
#define	RCR (0b00000000)	// Read Control Register
#define RBM (0b00111010)	// Read Buffer Memory
#define	WBM (0b01111010) 	// Write Buffer Memory
#define	SYSCMD (0b11111111)	// System SW Reset
