...
//
// Created: 05/06/2011                       Last Modified: 05/06/2011  11:29 AM
////////////////////////////////////////////////////////////////////////////////
// Description:
//  The following source code will initializing the I2C bus to allow
//  communication to a MAX6651 Fan Speed Controller.
//
//  I2C FAN Slave Address = 1001 000
//
//
//  TODO:
//
...
void FanFullOn(I2C_DRV *i2cDRV){
        ...
        i2cDRV->oData->buff = 0x0A;    // FULLON, 12 Volts, prescaler = 4
...
void FanFullOff(I2C_DRV *i2c){
        ...
        i2c->oData->buff = 0x1A;    // FULLOFF, 12 Volts, prescaler = 4
...
static int state=0, cntr=0, rtrycntr=0;
    ...
    {
    case 0:
           if (DEBUG) UARTSendChar( (char)state );
