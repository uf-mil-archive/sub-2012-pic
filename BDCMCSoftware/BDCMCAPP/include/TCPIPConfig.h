 ...
 */
// to simplify matters we reserve two sectors for configuration data
// the first sector of 4096 bytes stores touchscreen config data
// the second sector stores tcpip data
#define MPFS_RESERVE_BLOCK              (1024ul)

// base address for TCPIP config data (one sector from start)
#define MPFS_RESERVE_BASE				(4096ul)
...
#define MY_DEFAULT_MAC_BYTE6            (0xF7)
...
#define MY_DEFAULT_SECONDARY_DNS_BYTE3	(2ul)
 ...
 */
	...
	#define TCP_ETH_RAM_SIZE					(1649ul)
