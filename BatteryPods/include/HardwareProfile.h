...
//**************************HALL SWITCHES***************************/
//
//  Note:   Hall effect switches are pulled up on the Board.
...
#define KILLSW_TRIS     TRISBbits.TRISB11     // Kill Switch TRIS
#define KILLSW          PORTBbits.RB11        // Kill Switch IO
#define KILLSW_CN       CNEN1bits.CN15IE      // KillSW Change notification
